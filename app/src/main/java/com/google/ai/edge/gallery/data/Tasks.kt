...
private val allLegacyTaskIds: MutableSet<String> =
  mutableSetOf(
    ...
    // Note: LLM_TINY_GARDEN is intentionally NOT here anymore; the new StoCATstic Assistant is a
    // CustomTask (see customtasks/stocatstic) that renders its own Compose UI.
  )
