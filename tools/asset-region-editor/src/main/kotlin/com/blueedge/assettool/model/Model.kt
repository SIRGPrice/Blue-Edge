/*
 * Shared data model for the asset region editor. Persisted as JSON in
 *   tools/asset-regions/asset_regions.json
 * Consumed by the Kotlin code generator to emit AssetCatalogs.generated.kt.
 */
